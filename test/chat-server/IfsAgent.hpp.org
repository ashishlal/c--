...
const string turret_cn = "atp_turret";
...
int
HandleAgentTurretStatsParameter(netsnmp_mib_handler *handler,
                          netsnmp_handler_registration *reginfo,
                          netsnmp_agent_request_info *reqinfo,
                          netsnmp_request_info *requests);
int
HandleAgentGatewayStatsParameter(netsnmp_mib_handler *handler,
                                netsnmp_handler_registration *reginfo,
                                netsnmp_agent_request_info *reqinfo,
                                netsnmp_request_info *requests);
int
HandleAgentMixerStatsParameter(netsnmp_mib_handler *handler,
                               netsnmp_handler_registration *reginfo,
                               netsnmp_agent_request_info *reqinfo,
                               netsnmp_request_info *requests);
int
HandleAgentCommonStatsParameter(netsnmp_mib_handler *handler,
                               netsnmp_handler_registration *reginfo,
                               netsnmp_agent_request_info *reqinfo,
                               netsnmp_request_info *requests);
...
public:
    ...
    virtual bool initialise(int dev, string& host, string& atp_port,
                            string& site, string& org, string& common_name);
    virtual void mainloop_nonblocking(const boost::system::error_code& error);
    virtual void shutdown();
    virtual int snmpTrap(int level, string &errorMsg);
    friend int snmp_input(int operation, netsnmp_session * session, int reqid,
                          netsnmp_pdu *pdu, void *magic);
    friend void optProc(int argc, char *const *argv, int opt);
    friend int HandleAgentTurretStatsParameter(netsnmp_mib_handler *handler,
                               netsnmp_handler_registration *reginfo,
                               netsnmp_agent_request_info *reqinfo,
                               netsnmp_request_info *requests);
    friend int HandleAgentGatewayStatsParameter(netsnmp_mib_handler *handler,
                               netsnmp_handler_registration *reginfo,
                               netsnmp_agent_request_info *reqinfo,
                               netsnmp_request_info *requests);
    friend int HandleAgentMixerStatsParameter(netsnmp_mib_handler *handler,
                                   netsnmp_handler_registration *reginfo,
                                   netsnmp_agent_request_info *reqinfo,
                                   netsnmp_request_info *requests);
    friend int HandleAgentCommonStatsParameter(netsnmp_mib_handler *handler,
                                              netsnmp_handler_registration *reginfo,
                                              netsnmp_agent_request_info *reqinfo,
                                              netsnmp_request_info *requests);
    /* Common Stats */
    ...
    virtual void set_monitoring_host_port(string &s)
    {
        m_monitoring_agent_addr_port = s;
    }
    virtual string& get_monitoring_host_port()
    {
        return m_monitoring_agent_addr_port;
    }
    virtual void set_agentx_socket_loc(string &s)
    {
        m_agentx_loc = s;
    }
    virtual string& get_agentx_socket_loc()
    {
        return m_agentx_loc;
    }
    virtual void set_disable_snmp(string &s);
    ...
    virtual string& get_common_stat(unsigned int n) { return m_common_stats[n]; };
private:
    int m_deviceTypeBeingMonitored;
    int m_init;
    string m_monitoring_agent_addr_port;
    string m_agentx_loc;
    ...
    // Common Stats
    map<unsigned int, string> m_common_stats;
    // Mixer, Turret and GW stats callbacks
    map<unsigned int, SnmpCallback> m_stat_map;
};
